  ...
  return (
    <div className="w-full bg-[#020221] text-white font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col px-4 sm:px-6 py-6">
        <div className="py-3 px-4 sm:px-6 rounded-xl w-full mx-auto sm:mx-0">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-start gap-4 mt-3 mb-10">
          <div
            onClick={handleClick}
        ...
        <div className="py-1 px-4 sm:px-6 rounded-xl w-full mx-auto sm:mx-0 mb-6">
